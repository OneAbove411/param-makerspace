...
export function ManageChallenges() {
    ...
    const [form, setForm] = useState<Partial<Challenge>>({
        title: '', tier: '', domain: '', mystery: '', 
        core_idea: '', mission: '', success_criteria: '', status: 'draft'
    });
                    ...
                    <Card className="p-8 border-2 border-brutal-dark/20 border-t-8 border-t-brutal-red shadow-xl">
                        ...
                        <form onSubmit={handleSave} className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <Input label="Domain (e.g., Electronics)" value={form.domain || ''} onChange={e => setForm({...form, domain: e.target.value})} />
                                <Input label="Tier (e.g., Entry-level)" value={form.tier || ''} onChange={e => setForm({...form, tier: e.target.value})} />
                            </div>
                            ...
                            <div className="flex justify-end gap-4 pt-6 border-t-2 border-brutal-dark/10">
                                ...
                                <Button type="submit" disabled={actionLoading}>
                                    {actionLoading ? 'Saving...' : 'Save Challenge'}
                                </Button>
                            </div>
                        </form>
                    </Card>
